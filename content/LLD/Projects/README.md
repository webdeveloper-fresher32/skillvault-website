...
Copy the code block(s) from any file into a `.java` file and run it directly with `java <MainClass>.java` — no external packages, no build tools needed (Java 11+ single-file source launch).
...
| 5 | [ATM](05-ATM.md) | State (interface-based state machine) | Medium |
...
4. Run the **Demo** section — compile and execute it to see real output.
